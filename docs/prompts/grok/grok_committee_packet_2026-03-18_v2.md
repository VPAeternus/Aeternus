# Grok Committee Packet v2 (Upload-Ready) - 2026-03-18
...
```json
{
  ...
  "generated_at_utc": "2026-03-19T02:39:39.770030+00:00",
  "tickers": [
    "OXY",
    "VRT",
    "CF",
  ...
  "data_freshness": {
    "portfolio_snapshot_as_of": "2026-03-10T15:22:11.295026Z",
    "portfolio_snapshot_age_days": 8,
    "portfolio_snapshot_stale": true
  },
  "execution_readiness": {
    "status": "BLOCKED_STALE_CONTEXT",
    "reasons": [
      "Portfolio snapshot stale: 8 day(s) old (threshold 2). Refresh positions + live macro before executing new trades."
    ]
  },
  "search_policy": {
  ...
  "x_feed_context": {
    "summary": "Manual X-feed coverage for basket: 5/5 symbols. Pass artifacts loaded from eval_results/x_feed/2026-03-18.",
    "coverage": {
      "status": "READY",
      "target_tickers": [
        "OXY",
    ...
    "active_themes": [
      {
        ...
        "conviction": 0.85,
        "reasoning": "@AirbnBoost @EmmanuelInvest @AlAlphaResearch flagging nuclear plays OKLO CCJ CEG VST LEU plus 800V power/cooling upgrades NVDA VRT ETN NVTS for AI data center demand"
      },
      {
        "theme": "iran_war_energy_shock",
        "conviction": 0.9,
        "reasoning": "@TrueGemHunter @TheWealtharian highlighting Iran escalation driving oil spikes for CVX XOM and defense gains for PLTR CRWD LMT NOC RTX"
      }
    ],
    "high_signal_posts": [
      {
    ...
    "ticker_snapshot": {
      "OXY": {
        ...
        "source_pass_number": 6
      },
      "VRT": {
        "mentions_estimate": 8,
        "sentiment_score": 0.5,
        "velocity_trend": "stable",
        "source_pass_number": 12
      },
      "CF": {
        "mentions_estimate": 2,
        "sentiment_score": 0.5,
        "velocity_trend": "rising",
        "source_pass_number": 8
      },
      "CVX": {
        "mentions_estimate": 1,
        "sentiment_score": 0.5,
  ...
  "known_gaps": [
    "Portfolio snapshot is stale by 8 day(s): snapshot=2026-03-10T15:22:11.295026Z, as_of_date=2026-03-18."
  ]
}
```
