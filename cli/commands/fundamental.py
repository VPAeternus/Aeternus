...
def fundamental_right_tail_queues(
    ...
    if fmt == "json":
        ...
        paths = result["output_paths"]
        console.print(f"[green]Wrote[/green] {paths['top15_exception_candidate_queue']} | {paths['right_tail_scout_queue']} | {paths['demote_review_queue']} | {paths['thin_signal_watchlist_queue']} | {paths['right_tail_evidence_score_diagnostics']}")
