...
def test_complete_panel_schema_includes_operator_required_groups():
    ...
    for field in [
        ...
        "revenue_value_fact_namespace",
        "revenue_value_fact_accession",
        "revenue_value_fact_period_type",
        "revenue_value_derivation_formula",
        "operating_cash_flow_value_derivation_source_facts_json",
        "source_run_root",
        "source_artifact",
