...
def generate_analysis_post(report: dict) -> str:
    ...
    # Judge
    judge = report.get("final_trade_decision", "")
    ...
    risk_
    judge = report.get("final_trade_decision", "")
    risk_line = _first_sentence(trader) if trader else ""
...
def generate_article(report: dict) -> str:
    ...
    bull = ""
    bear = ""
    discussion_synthesis = discussion.get("history", "")
    judge = discussion.get("judge_decision", "")
    ...
    if discussion_synthesis:
        sections.append("## Debate Synthesis")
        sections.append(discussion_synthesis)
    ...
    sections.append(
        ...
        "analysts and trader collaborate to produce investment "
