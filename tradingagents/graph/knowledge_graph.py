...
# ---------------------------------------------------------------------------
# Seed data: supply chain map (fallback when sec_catalyst.py is not yet merged)
# S-034 (sec_catalyst.py) defines its own SUPPLY_CHAIN_MAP; if that module
# exists we import from there at seed time.  Until it lands this inline map
