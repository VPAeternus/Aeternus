...
DEFAULT_PICKS = OUT_DIR / "walkforward_picks.csv"
DEFAULT_SUMMARY = OUT_DIR / "walkforward_summary.csv"
DEFAULT_CANDIDATES = OUT_DIR / "walkforward_candidates.csv"
...
def pick_walkforward(candidates: list[dict[str, object]], top_n: int, min_score: float, rebalance_period: str) -> list[dict[str, object]]:
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Walkforward event + venture capital priority picker")
...
def main() -> None:
    ...
    picks = pick_walkforward(candidates, args.top_n, args.min_score, args.rebalance_period)
