...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--bundle-dir", default=str(default_backtest_output_root() / "high_conviction_top15_exception_sleeve"))
    parser.add_argument("--prior-analysis-dir", default=str(default_backtest_output_root() / "analysis"))
    parser.add_argument("--out-dir", default=str(default_backtest_output_root() / "analysis_top15_exception"))
    parser.add_argument("--report", default="tradingagents/research/fundamental/docs/top15_exception_sleeve_observed_backtest_analysis.md")
