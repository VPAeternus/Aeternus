...
This script reads the fundamental backtest artifacts under the framework run root
...
BASE = default_backtest_output_root()
TOP10 = BASE / "high_conviction_top10"
ANALYSIS = BASE / "analysis"
REPORT = Path("tradingagents/research/fundamental/docs/top10_observed_backtest_analysis.md")
